...
const Contact = () => {
  return (
    <div className="relative flex items-center justify-center h-auto bg-whitesm:items-center sm:pt-0 sm:py-32 sm:mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="p-6 mr-2 bg-gray-100 rounded-md sm:rounded-lg">
              ...
              <div className="flex items-center mt-4 text-gray-600 ">
                H. N0. - 105 A, Gate No. 2,
                <br />
                Victoria Estate, Pathankot,
                <br />
                Punjab - 145001
              </div>
            ...
            <htmlForm
              action=""
              method="post"
              className="p-6 flex flex-col justify-center mr-2 bg-gray-300 rounded-md sm:rounded-lg"
            >
